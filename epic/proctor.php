	...
	<body>
		...
		<div>
			...
			<ul>
				...
				<li><strong>Personality</strong>: Quite and down-to-earth. Holds her students in high regards and holds them
					to high expectations. Kind but professionally demanding.
				</li>
				...
				<li><strong>Technology</strong>: Solely a PC user
					<ul>
						...
						<li><strong>Proficiency: </strong>Day to day user with average knowledge of the machine and in
							applications.
						</li>
						<li><strong>Love/Hate </strong>Loves to teach via digital media however she hates her options to do
							so.
						</li>
					</ul>
				</li>
				<li><strong>Attitudes and Needs</strong>
					<ul>
						<li><strong>What need does this person have? </strong> Janet needs to present her course material to
							her students in a fun and engaging manner.
						</li>
						<li><strong>Why choose your site over other options? </strong> Q-Review is designed to make sometimes
							tedious material more enjoyable for students to learn by presenting the information in a game
							format. When an individual is enjoying themselves, retention and interest can be enhanced.
						</li>
					</ul>
				</li>
			</ul>
			...
			<ul>
				...
				<li><strong>Post-conditions:</strong>Janet ends the game having inspired three students to invest more time
					into studying Biology.
				</li>
			...
			<ul>
				...
				<li><strong>User: </strong>Janet approves or denies "Players" answers by clicking "yes" or "no" next to each
					one
				</li>
