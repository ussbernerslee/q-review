...
try {
	...
	$pdo = connectToEncryptedMySQL("/etc/apache2/capstone-mysql/q-review.ini");
...
EOF;
		...
		// update reply
		$reply->message = "Thank you for creating a q-review profile. One more step before you can start playing the game, you need to verify your email address";
	} else {
