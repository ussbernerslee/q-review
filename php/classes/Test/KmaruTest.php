 ...
 *
 * This class is designed to lay the foundation of the unit tests for Kmaru. It loads the all the database
 ...
 **/
abstract class KmaruTest extends TestCase {
	use TestCaseTrait;
	/**
	...
	public final function getConnection() : Connection {
		...
		if($this->connection === null) {
			...
			$config = readConfig("/etc/apache2/capstone-mysql/NEED.ini");
			$pdo = connectToEncryptedMySQL("/etc/apache2/capstone-mysql/NEED.ini");
