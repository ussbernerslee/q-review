...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Navigation for Capstone Documentation</title>
	</head>
	<body>
		...
		<ol>
			...
			<li><a href="epic/user-interaction-flow.php">Interaction Flow Draft</a></li>
			<li><a href="epic/user-goals.php">User Goals Draft</a></li>
	</body>
</html>